...
public class sample {
	...
	/*
	 ...
	 7. UAT schedult/Time planning, before doing this UAT testing we want to do functional testing, 
	 	system testing and regression testing then only it was moved to UAT testing.
